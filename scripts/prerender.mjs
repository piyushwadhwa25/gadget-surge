...
const routeMeta = {
  ...
  '/tools/chmod-calculator': { title: 'chmod Calculator — Octal & Symbolic Permissions | GadgetSurge', description: 'Convert chmod 755, rwxr-xr-x, and special bits to octal, symbolic, and shell commands. Free chmod calculator runs in your browser.', canonical: `${BASE_URL}/tools/chmod-calculator` },
  '/tools/px-to-rem-converter': { title: 'PX to REM Converter — CSS Unit Calculator | GadgetSurge', description: 'Convert px to rem at any root font size. Batch-convert CSS and skip 1px borders. Free px to rem tool runs entirely in your browser.', canonical: `${BASE_URL}/tools/px-to-rem-converter` },
  '/tools/env-to-json-converter': { title: 'ENV to JSON Converter — Dotenv ↔ JSON | GadgetSurge', description: 'Convert .env to JSON or JSON to .env with export stripping and quote rules. Warnings for duplicates. Runs in your browser — secrets stay local.', canonical: `${BASE_URL}/tools/env-to-json-converter` },
  '/tools/line-ending-converter': { title: 'Line Ending Converter — CRLF to LF Online | GadgetSurge', description: 'Convert CRLF, LF, or CR line endings. Detect mixed endings and UTF-8 BOM. Download fixed files — processing runs entirely in your browser.', canonical: `${BASE_URL}/tools/line-ending-converter` },
  '/tools/nanoid-generator': { title: 'NanoID Generator — Short IDs & ULID Online | GadgetSurge', description: 'Generate URL-safe NanoIDs and sortable ULIDs with crypto.getRandomValues. Bulk generation up to 100. Runs entirely in your browser.', canonical: `${BASE_URL}/tools/nanoid-generator` },
};
