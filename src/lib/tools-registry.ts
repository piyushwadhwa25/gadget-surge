...
export const categories: CategoryConfig[] = [
  ...
  },
  {
    ...
    introText: 'A collection of free browser-based document tools. Merge, split, and edit PDFs, count words in your documents, and more — all processing happens entirely in your browser. Your files never leave your device.',
    whoIsItFor: 'Students, writers, office workers, researchers, and anyone who works with PDFs or needs document text analysis.',
    commonUseCases: ['Merging multiple PDF files into one document', 'Removing unwanted pages from a PDF', 'Splitting a PDF into smaller files', 'Counting words and estimating reading time'],
    faqItems: [
      { question: 'Are my PDFs uploaded to a server?', answer: 'No. All PDF processing happens locally in your browser using pdf-lib. Your files never leave your device.' },
      { question: 'Do these tools work with password-protected PDFs?', answer: 'No. Password-protected or encrypted PDFs must be unlocked before using these tools.' },
      { question: 'Is there a file size limit?', answer: 'There is no hard limit, but very large PDFs may process slowly depending on your device and browser memory.' },
    ],
  ...
  },
  {
    ...
    introText: 'Free browser-based calculators for developers and power users. Convert Unix timestamps, parse cron expressions, check WCAG color contrast, and convert storage units — all running locally in your browser.',
    whoIsItFor: 'Developers, DevOps engineers, designers, and sysadmins who need quick utility calculations without leaving the browser.',
    commonUseCases: ['Converting Unix timestamps for API debugging', 'Validating cron schedules for CI/CD', 'Checking WCAG color contrast for accessible UI', 'Converting bytes, KiB, and GB for storage planning'],
    faqItems: [
      { question: 'Are these calculators free?', answer: 'Yes. All calculators are completely free with no signup required.' },
      { question: 'Is my input sent to a server?', answer: 'No. All calculations happen locally in your browser.' },
      { question: 'Do I need to install anything?', answer: 'No. Just open the page and use the calculator.' },
    ],
    relatedCategorySlugs: ['developer-tools', 'image-tools'],
  },
];
