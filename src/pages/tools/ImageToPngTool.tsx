...
export function ImageToPngTool({ tool }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {!file && <p className="text-sm text-muted-foreground py-8 text-center border border-dashed border-border rounded-lg">Upload an image to convert to PNG.</p>}
    </div>
  );
}
